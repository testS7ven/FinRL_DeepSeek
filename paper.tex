...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{risk_first/results/equity_curves.png}
  \caption{Equity curves — ablation A through F vs QQQ benchmark (2019-2023). Config F (Risk-First Full) achieves the lowest Max Drawdown while maintaining strong returns.}
